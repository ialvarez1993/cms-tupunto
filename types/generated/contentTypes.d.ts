...
export interface ApiAcercaDeAcercaDe extends Struct.SingleTypeSchema {
  collectionName: 'acerca_de_nosotros';
  info: {
  ...
  attributes: {
    HistoriaMision: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    HistoriaFundadores: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    HistoriaVision: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    HistoriaFundacion: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ValorNombre: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ValorDescripcion: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    EquipoNombreNombre: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    EquipoNombreCargo: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    EquipoNombreDescripcion: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    CoordenadasLatitud: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    CoordenadasLongitud: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    UbicacionTipo: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    UbicacionDireccion: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    UbicacionCiudad: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    UbicacionCodigoPostal: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDescuentoImperdibleDescuentoImperdible
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::descuento-imperdible.descuento-imperdible'
    >;
  };
}
...
export interface ApiHomePromoHomePromo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    promoImagenLateral: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-promo.home-promo'
    >;
  };
}

export interface ApiHomeSamsungCardHomeSamsungCard
  extends Struct.SingleTypeSchema {
  collectionName: 'home_samsung_cards';
  info: {
  ...
  attributes: {
    titleOneColorWhite: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    bottontext: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    titleTwoColorWhite: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-samsung-card.home-samsung-card'
    >;
  };
}

export interface ApiHomeTarjetaDescuentoHomeTarjetaDescuento
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_tarjetas_descuentos';
  info: {
  ...
  attributes: {
    ...
    imagenCard: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-tarjeta-descuento.home-tarjeta-descuento'
    >;
  };
}

export interface ApiHomeTituloPopularHomeTituloPopular
  extends Struct.SingleTypeSchema {
  collectionName: 'home_titulo_populares';
  info: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-titulo-popular.home-titulo-popular'
    >;
  };
}

export interface ApiIconoHomeIconoHome extends Struct.CollectionTypeSchema {
  collectionName: 'iconos_homes';
  info: {
...
export interface ApiTitleDiscountTitleDiscount extends Struct.SingleTypeSchema {
  collectionName: 'title_discounts';
  info: {
  ...
  attributes: {
    TitleDiscount: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ButtonExplorar: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::title-discount.title-discount'
    >;
  };
}

export interface ApiTituloCategoriaTituloCategoria
  extends Struct.SingleTypeSchema {
  collectionName: 'titulo_categorias';
  info: {
  ...
  attributes: {
    TituloCategoria: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::titulo-categoria.titulo-categoria'
    >;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::home-titulo-popular.home-titulo-popular': ApiHomeTituloPopularHomeTituloPopular;
